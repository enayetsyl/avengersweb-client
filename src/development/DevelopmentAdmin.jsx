...
import LeadCollectorTable from '../marketing/components/LeadCollectorTable';
...
// Populating data based on tab clicked
 const fetchData = async(selectedTab) => {
  switch(selectedTab){
    ...
    case 1:
      return axios.get('http://localhost:5000/api/v1/developer').then((response) => response.data)
      default:
        return []
  }
 }
